 ...
 * has occurred.
 */
typedef int32_t ( * AzureIoTTransportWritev_t )( struct NetworkContext * pxNetworkContext,
                                                    struct TransportOutVector * pIoVec,
                                                    size_t ioVecCount );
...
typedef struct AzureIoTTransportInterface
{
    ...
    AzureIoTTransportWritev_t xWritev;        /**< Transport writev function pointer. */
