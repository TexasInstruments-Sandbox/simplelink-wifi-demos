...
/**
 * @file aws_iot_transport_interface.h
 * @brief Transport interface definition to send and receive data over the
 * network.
 */

#ifndef AWS_IOT_TRANSPORT_INTERFACE_H
#define AWS_IOT_TRANSPORT_INTERFACE_H
 ...
 * - [Transport Receive](@ref AwsIoTTransportRecv_t)
 * - [Transport Send](@ref AwsIoTTransportSend_t)
 *
 ...
 * @ref AwsIoTTransportInterface_t structure:<br><br>
 ...
 * that is needed to receive and send data with the @ref AwsIoTTransportRecv_t
 * and the @ref AwsIoTTransportSend_t implementations.<br>
 ...
 * @endcode
 * <br>
 * -# Implementing @ref AwsIoTTransportRecv_t<br><br>
 ...
 * In the case of TLS over TCP, @ref AwsIoTTransportRecv_t is typically implemented by
 ...
 * function. @ref AwsIoTTransportRecv_t may be invoked multiple times by the protocol
 ...
 * @endcode
 * <br>
 * -# Implementing @ref AwsIoTTransportSend_t<br><br>
 ...
 * In the case of TLS over TCP, @ref AwsIoTTransportSend_t is typically implemented by
 ...
 * function. @ref AwsIoTTransportSend_t may be invoked multiple times by the protocol
 ...
 */
typedef int32_t ( * AwsIoTTransportRecv_t )( struct NetworkContext * pxNetworkContext,
                                               void * pvBuffer,
                                               size_t xBytesToRecv );
 ...
 */
typedef int32_t ( * AwsIoTTransportSend_t )( struct NetworkContext * pxNetworkContext,
                                               const void * pvBuffer,
                                               size_t xBytesToSend );
 ...
 */
typedef struct AwsIoTTransportInterface
{
    AwsIoTTransportRecv_t xRecv;            /**< Transport receive interface. */
    AwsIoTTransportSend_t xSend;            /**< Transport send interface. */
    struct NetworkContext * pxNetworkContext; /**< Implementation-defined network context. */
} AwsIoTTransportInterface_t;

#endif /* AWS_IOT_TRANSPORT_INTERFACE_H */
